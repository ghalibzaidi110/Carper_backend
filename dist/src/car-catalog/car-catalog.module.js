...
exports.CarCatalogModule = CarCatalogModule = __decorate([
    (0, common_1.Module)({
        ...
        controllers: [car_catalog_controller_1.CarCatalogController],
        providers: [car_catalog_service_1.CarCatalogService],
        exports: [car_catalog_service_1.CarCatalogService],
    })
], CarCatalogModule);
//# sourceMappingURL=car-catalog.module.js.map